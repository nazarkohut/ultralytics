...
class ResBlockOriginalCBAM(nn.Module):
    def __init__(self, in_places, places, stride=1, downsampling=False, expansion=1):
        super(ResBlockOriginalCBAM, self).__init__()
        self.expansion = expansion
        self.downsampling = downsampling
        ...
        self.original_cbam = OriginalCBAM(places * self.expansion)
